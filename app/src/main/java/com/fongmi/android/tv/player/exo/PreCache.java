...
public class PreCache implements Player.Listener {
    ...
    private PreCacheHelper createHelper(MediaItem mediaItem) {
        ...
        PreCacheHelper created = new PreCacheHelper.Factory(MediaSourceFactory.scopedCache(ExoUtil.extractHeaders(mediaItem)), upstreamFactory, ExoUtil.buildRenderersFactory(), activeWorker.getLooper())
