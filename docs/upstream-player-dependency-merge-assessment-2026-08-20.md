...
| --- | --- | --- | --- | --- |
| `E-SP8` | Exo 性能/播放行为 | 基于现有短剧源设置的单实例队列连播、下一集预解析与受控预加载 | **2026-09-08 已批准按计划实施，进行中**；实验默认关闭，代码／双端设备对照与正式放量尚未完成；不变更依赖 | [E-SP8-exo-short-drama-queue.md](E-SP8-exo-short-drama-queue.md) |
